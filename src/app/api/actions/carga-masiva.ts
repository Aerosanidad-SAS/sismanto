    ...
    for (let j = 0; j < lote.length; j++) {
      ...
      try {
        const rowParsed = filaVehiculoImportSchema.safeParse({
          ...
          bombilleria_farolas: raw.bombilleria_farolas,
          bombilleria_stops: raw.bombilleria_stops,
          bombilleria_direccionales: raw.bombilleria_direccionales,
          ...
          bateria_principal: raw.bateria_principal,
          bateria_auxiliar: raw.bateria_auxiliar,
          notas: raw.notas,
