...
import { getCatalogosCaptacion } from "@/app/api/actions/captacion";
...
export default async function NuevaCaptacionPage() {
  ...
  const catalogos = await getCatalogosCaptacion();
  ...
  return (
    <div className="space-y-8">
      ...
      <FormularioCaptacion catalogos={catalogos} medicoPorDefecto={profile.role_codigo === "MEDICO" ? (profile.nombre_completo ?? "") : ""} />
    </div>
  );
}
