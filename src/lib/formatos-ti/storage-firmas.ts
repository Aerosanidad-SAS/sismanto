/**
 * Firmas en Storage (bucket privado `formatos-firmas`): guardar, borrar, URL firmada y descarga. Sin dependencias
 * de Next ni de la sesión, para poder probarlas con un Storage de mentira.
 */
import type { SupabaseClient } from "@supabase/supabase-js";
import type { Database } from "@/lib/supabase/database.types";
import { BUCKET_FIRMAS } from "./comun";
